...
export const academyClasses: AcademyClass[] = [
  {
    ...
    coach: '김민수 코치',
    coachImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&q=80',
    level: 'beginner',
    ...
    image: 'https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&h=450&fit=crop&q=80',
  },
  {
    id: 'class-002',
    title: '실력 향상 중급반',
    ...
    price: 300000,
    location: '스매시 배드민턴 아카데미 (서울 강남구)',
    image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&h=450&fit=crop&q=80',
  },
  {
    id: 'class-003',
    title: '대회 준비 상급반',
    coach: '박지현 코치',
    coachImage: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop&q=80',
    level: 'advanced',
  ...
  },
  {
    ...
    title: '주니어 배드민턴 교실',
    coach: '이서연 코치',
    coachImage: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop&q=80',
    level: 'beginner',
